...
__attribute__((aligned(16))) uint8_t sub_0015_arena[73728];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0015_fast_scratch[73728];
...
int sub_0015_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0015_model with size 8752 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0015_model_data;
  base_addrs_size[0] = sub_0015_model_data_size;
  // Buffer sub_0015_arena with size 73728 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0015_arena+0);
  base_addrs_size[1] = 73728;

  // Buffer sub_0015_fast_scratch with size 73728 and address: 0
  ...
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0015_arena+24576);
  base_addrs_size[5] = 24576;

  // Buffer output_tensor_1 with size 24576 and address: 0
  if (clean_outputs) {
    memset(sub_0015_arena + 0, 0, 24576);
  }
