...
__attribute__((aligned(16))) uint8_t sub_0003_arena[278784];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0003_fast_scratch[278784];
...
int sub_0003_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0003_model with size 3120 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0003_model_data;
  base_addrs_size[0] = sub_0003_model_data_size;
  // Buffer sub_0003_arena with size 278784 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[1] = 278784;

  // Buffer sub_0003_fast_scratch with size 278784 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[2] = 278784;

  // Buffer input_tensor_0 with size 46464 and address: 46464
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0003_arena+46464);
  base_addrs_size[3] = 46464;

  // Buffer input_tensor_1 with size 46464 and address: 92928
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0003_arena+92928);
  base_addrs_size[4] = 46464;

  // Buffer output_tensor_0 with size 92928 and address: 92928
  if (clean_outputs) {
    memset(sub_0003_arena + 92928, 0, 92928);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0003_arena+92928);
  base_addrs_size[5] = 92928;

  // Buffer output_tensor_1 with size 92928 and address: 0
  if (clean_outputs) {
    memset(sub_0003_arena + 0, 0, 92928);
  }
  base_addrs[6] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[6] = 92928;
