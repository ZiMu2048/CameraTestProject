...
__attribute__((aligned(16))) uint8_t sub_0003_arena[147456];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0003_fast_scratch[147456];
...
int sub_0003_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0003_arena with size 147456 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[1] = 147456;

  // Buffer sub_0003_fast_scratch with size 147456 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[2] = 147456;

  // Buffer input_tensor_0 with size 24576 and address: 0
  ...
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0003_arena+49152);
  base_addrs_size[5] = 49152;

  // Buffer output_tensor_1 with size 49152 and address: 0
  if (clean_outputs) {
    memset(sub_0003_arena + 0, 0, 49152);
  }
