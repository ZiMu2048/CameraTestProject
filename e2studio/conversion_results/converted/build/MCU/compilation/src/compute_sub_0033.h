...
/*
 kBufferSize_sub_0033 is a compile-time constant to be used by the user of compute_sub_0033 function
 ...
 Example of how to call the compute function:
   ...
   uint8_t my_buffer[kBufferSize_sub_0033];

   int main() {
     ...
     compute_sub_0033(my_buffer, input, output);
   }
*/
enum BufferSize_sub_0033 {

#if defined(ARM_MATH_MVEI)
  kBufferSize_sub_0033 = 9
