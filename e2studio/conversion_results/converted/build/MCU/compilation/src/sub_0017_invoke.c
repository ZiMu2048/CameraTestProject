...
__attribute__((aligned(16))) uint8_t sub_0017_arena[139392];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0017_fast_scratch[139392];
...
int sub_0017_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0017_model with size 8656 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0017_model_data;
  base_addrs_size[0] = sub_0017_model_data_size;
  // Buffer sub_0017_arena with size 139392 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0017_arena+0);
  base_addrs_size[1] = 139392;

  // Buffer sub_0017_fast_scratch with size 139392 and address: 0
  ...
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0017_arena+46464);
  base_addrs_size[4] = 23232;

  // Buffer output_tensor_0 with size 46464 and address: 46464
  if (clean_outputs) {
    memset(sub_0017_arena + 46464, 0, 46464);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0017_arena+46464);
  base_addrs_size[5] = 46464;

  // Buffer output_tensor_1 with size 46464 and address: 0
  if (clean_outputs) {
    memset(sub_0017_arena + 0, 0, 46464);
  }
