...
__attribute__((aligned(16))) uint8_t sub_0029_arena[147456];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0029_fast_scratch[147456];
...
int sub_0029_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0029_model with size 61856 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0029_model_data;
  base_addrs_size[0] = sub_0029_model_data_size;
  // Buffer sub_0029_arena with size 147456 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0029_arena+0);
  base_addrs_size[1] = 147456;

  // Buffer sub_0029_fast_scratch with size 147456 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0029_arena+0);
  base_addrs_size[2] = 147456;

  // Buffer input_tensor_0 with size 49152 and address: 98304
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0029_arena+98304);
  ...
  // Buffer output_tensor_0 with size 6912 and address: 6912
  if (clean_outputs) {
    memset(sub_0029_arena + 6912, 0, 6912);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0029_arena+6912);
