...
const TensorInfo sub_0008_tensors[] = {
  { "_split_1_command_stream", 0, 576, "COMMAND_STREAM", 0xffffffff },
  { "_split_1_flash", 1, 34720, "MODEL", 0xffffffff },
  { "_split_1_scratch", 2, 20480, "ARENA", 0x0 },
  { "_split_1_scratch_fast", 3, 20480, "FAST_SCRATCH", 0x0 },
  { "functional_1_bb08_csp_bn_1_concatenate_133_1_concat_70238", 4, 12288, "INPUT_TENSOR", 0x0 },
  ...
  { "functional_1_bb09_spp_1_max_pooling2d_2_1_MaxPool2d_70241", 6, 4096, "OUTPUT_TENSOR", 0x1000 },
  { "functional_1_bb09_spp_1_max_pooling2d_2_3_MaxPool2d_70242", 7, 4096, "OUTPUT_TENSOR", 0x2000 },
  { "functional_1_bb09_spp_1_max_pooling2d_2_5_MaxPool2d_70243", 8, 4096, "OUTPUT_TENSOR", 0x3000 },
};
...
const uint32_t sub_0008_address_functional_1_bb09_spp_1_max_pooling2d_2_1_MaxPool2d_70241 = 0x1000;
const uint32_t sub_0008_address_functional_1_bb09_spp_1_max_pooling2d_2_3_MaxPool2d_70242 = 0x2000;
const uint32_t sub_0008_address_functional_1_bb09_spp_1_max_pooling2d_2_5_MaxPool2d_70243 = 0x3000;
