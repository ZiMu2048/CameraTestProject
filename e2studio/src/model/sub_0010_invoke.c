...
__attribute__((aligned(32), section(".sdram_noinit_nocache"))) uint8_t sub_0010_arena[24576];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0010_fast_scratch[24576];
...
int sub_0010_invoke(bool clean_outputs) {
  ...
  if (clean_outputs) {
    memset(sub_0010_arena + 0, 0, 4096);
  }
  ...
  if (clean_outputs) {
    memset(sub_0010_arena + 4096, 0, 4096);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0010_arena+4096);
  base_addrs_size[5] = 4096;

  // Buffer output_tensor_2 with size 4096 and address: 8192
  if (clean_outputs) {
    memset(sub_0010_arena + 8192, 0, 4096);
  }
  base_addrs[6] = (uint64_t)(uintptr_t) (sub_0010_arena+8192);
