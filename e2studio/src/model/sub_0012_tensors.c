...
const TensorInfo sub_0012_tensors[] = {
  { "_split_1_command_stream", 0, 788, "COMMAND_STREAM", 0xffffffff },
  { "_split_1_flash", 1, 35808, "MODEL", 0xffffffff },
  { "_split_1_scratch", 2, 49152, "ARENA", 0x0 },
  { "_split_1_scratch_fast", 3, 49152, "FAST_SCRATCH", 0x0 },
  { "functional_1_bb10_csp_cib_1_concatenate_135_1_concat_70259", 5, 12288, "INPUT_TENSOR", 0x2000 },
  ...
  { "functional_1_pan1_upsample_1_resize_ResizeBilinear_70262", 6, 32768, "OUTPUT_TENSOR", 0x4000 },
};

const size_t sub_0012_tensors_count = sizeof(sub_0012_tensors) / sizeof(sub_0012_tensors[0]);

// Addresses for each input and output buffer inside of the arena
const uint32_t sub_0012_address_functional_1_bb10_csp_cib_1_concatenate_135_1_concat_70259 = 0x2000;
...
const uint32_t sub_0012_address_functional_1_pan1_upsample_1_resize_ResizeBilinear_70262 = 0x4000;
